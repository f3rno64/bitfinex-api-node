...
class WSv2 extends EventEmitter {
  ...
  /**
   * Send out a broadcast notification payload to be picked up by the UI or
   * other connected API clients.
   *
   * @param {Object} opts
   ...
   */
  broadcastNotification ({ message, type, level, image, link, sound } = {}) {
    this.send([0, 'n', null, {
